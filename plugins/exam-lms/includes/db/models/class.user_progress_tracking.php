 ...
 */
class EXMS_DB_USER_PROGRESS_TRACKING extends EXMS_DB_Main {
	 ...
	 * @var integer
	 */
	protected $table = 'user_progress_tracking';

	/**
	 * Initiate new background process.
	 */
	private $table_script = 'id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
