...
class Config
{
    ...
    const WORK_ROOT = '/stripe-payment/';

    const HOME_URL = Config::APP_ROOT . Config::WORK_ROOT;

    /* Stripe API test keys */
    const STRIPE_PUBLISHIABLE_KEY = "pk_test_51IpdyWAiLaIEgYsTABnplBvyWLQLn9aQK5PaDfSMMeQVR2MzWp2RhgRLHiWeTN4RtvdFl2efuFxugMWgLpJhhJYG00ALOSRFgH";

    const STRIPE_SECRET_KEY = "sk_test_51IpdyWAiLaIEgYsThGMb25PIGS7sX9EsRgEngSjdPB9nXbPWTuAVGkL369Tscc0lo04cfFUYB7DsOWhuhNXoq7zk00zj5U6Hht";
