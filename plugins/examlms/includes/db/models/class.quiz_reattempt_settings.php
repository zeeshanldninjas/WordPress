 ...
 */
class EXMS_DB_QUIZ_REATTEMPT_SETTINGS extends EXMS_DB_Main {
	 ...
	 * @var integer
	 */
	protected $table = 'quiz_reattempt_settings';
	...
	private $table_script = 'id INT AUTO_INCREMENT PRIMARY KEY,
							...
							quiz_reattempts varchar(30) NOT NULL,
							quiz_reattempts_no int(11) NOT NULL,
							quiz_reattempts_type varchar(30) NOT NULL,
							quiz_reattempts_field varchar(30) NOT NULL
							';
	/**
	 * create table.
	 */
