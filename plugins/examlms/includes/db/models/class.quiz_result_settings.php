 ...
 */
class EXMS_DB_QUIZ_SETTINGS extends EXMS_DB_Main {
	 ...
	 * @var integer
	 */
	protected $table = 'quiz_result_settings';
	...
	private $table_script = 'id INT AUTO_INCREMENT PRIMARY KEY,
							...
							question_answer_summary varchar(30) NOT NULL,
							correct_incorrect_status varchar(30) NOT NULL
							';
	/**
	 * create table.
	 */
