...
/**
 * Template to display [exms_student_dashboard] shortcode groups content
 */
if (! defined('ABSPATH')) exit;
?>
<h3 class="exms-std-dashboard-heading"> <?php echo __('My Groups', 'exms'); ?></h3>
<div class="exms-std-course-content">
    <div class="exms-std-course-filters">
        <div class="exms-std-course-filters-fields">
            ...
            <select name="" id="exms-my-group-dropdown">
        ...
        <div class="exms-std-course-filters-fields">
            ...
            <select name="" id="">
                <option value="today"><?php echo __('Bilal Ahmed', 'exms'); ?></option>
            </select>
        </div>
    </div>
